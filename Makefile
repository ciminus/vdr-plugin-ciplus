...
extralibs:
	for dir in $(EXTRALIBDIRS); do \
	    make -C $$dir; \
	done

install-extralibs: extralibs
	for dir in $(EXTRALIBDIRS); do \
	    make -C $$dir install; \
	done
...
install: install-lib install-i18n install-extralibs
